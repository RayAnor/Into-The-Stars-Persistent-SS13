...
/material/crayonwax/generate_recipes()
	..()
	recipes += new/datum/stack_recipe("Red Crayon", /obj/item/weapon/pen/crayon/red, 1, time = 25)
	recipes += new/datum/stack_recipe("Orange Crayon", /obj/item/weapon/pen/crayon/orange, 1, time = 25)
	recipes += new/datum/stack_recipe("Yellow Crayon", /obj/item/weapon/pen/crayon/yellow, 1, time = 25)
	recipes += new/datum/stack_recipe("Green Crayon", /obj/item/weapon/pen/crayon/green, 1, time = 25)
	recipes += new/datum/stack_recipe("Blue Crayon", /obj/item/weapon/pen/crayon/blue, 1, time = 25)
	recipes += new/datum/stack_recipe("Purple Crayon", /obj/item/weapon/pen/crayon/purple, 1, time = 25)
	recipes += new/datum/stack_recipe("Mime Crayon", /obj/item/weapon/pen/crayon/mime, 1, time = 50)
	recipes += new/datum/stack_recipe("Rainbow Crayon", /obj/item/weapon/pen/crayon/rainbow, 1, time = 80)
